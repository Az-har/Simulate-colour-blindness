...
def main():
    # Simulating Protanopia with diagnosed degree of 1 and saving the image to file.
    Core.simulate(input_path='Examples_Check/ex_original.jpg',
                  ...
                  simulate_degree_primary=1)

    # Simulating Deutranopia with diagnosed degree of 1 and saving the image to file.
    Core.simulate(input_path='Examples_Check/ex_original.jpg',
                  return_type='save',
    ...
    # Simulating Tritanopia with diagnosed degree of 1 and saving the image to file.
    Core.simulate(input_path='Examples_Check/ex_original.jpg',
                  return_type='save',
